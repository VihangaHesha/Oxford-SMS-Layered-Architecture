...
public class StudentFormController implements Initializable {
    ...
    public void btnStudentAddOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student_forms/add_student_form.fxml"));
        Parent fxml = loader.load();
        AddStudentFormContoller addStudentFormController = loader.getController();
        addStudentFormController.setUser(user);
        container.getChildren().removeAll();
        container.getChildren().setAll(fxml);
    }
    ...
    public void btnStudentEditOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student_forms/edit_student_form.fxml"));
        Parent fxml = loader.load();
        EditStudentFormController editStudentFormController = loader.getController();
        editStudentFormController.setUser(user);
        container.getChildren().removeAll();
        container.getChildren().setAll(fxml);
    }
